...
var _user$project$Types$Boundary = F4(
	function (a, b, c, d) {
		return {x1: a, x2: b, y1: c, y2: d};
	});
var _user$project$Types$Weapon = F2(
	function (a, b) {
		return {weaponType: a, force: b};
	});
var _user$project$Types$Sphere = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {id: a, position: b, mass: c, diameter: d, velocity: e, aliveFrames: f, scale: g, merged: h, hitType: i, side: j};
									};
								};
							};
						};
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {spheres: a, players: b, state: c, graphicSettings: d, leftSideLine: e, rightSideLine: f, physicsSettings: g, gameSettings: h, winStates: i, innerContainer: j, outerContainer: k, mdl: l};
											};
										};
									};
								};
...
var _user$project$Types$Player = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {number: a, position: b, side: c, score: d, size: e, velocity: f, upAction: g, downAction: h, mass: i, selectedWeapon: j, ammo: k, weapons: l, weaponLastFired: m, gamesWon: n, name: o};
														};
													};
												};
											};
...
var _user$project$Types$WinStates = F2(
	function (a, b) {
		return {gameWinState: a, setWinState: b};
	});
var _user$project$Types$GameSettings = F7(
	function (a, b, c, d, e, f, g) {
		return {scoreForGame: a, scoreForSet: b, maxShotSize: c, minShotSize: d, shotTimeFactor: e, sphereLimit: f, gamesToWin: g};
	});
var _user$project$Types$GraphicSettings = F2(
	function (a, b) {
		return {graphicWidth: a, graphicHeight: b};
	});
var _user$project$Types$PhysicsSettings = F7(
	function (a, b, c, d, e, f, g) {
		return {gravitationalConstant: a, boundaryDampner: b, maxSphereVelocity: c, maxSphereSize: d, gravityAttractionType: e, maxGravitationalConstant: f, minGravitationalConstant: g};
	});
var _user$project$Types$SideLine = F5(
	function (a, b, c, d, e) {
		return {side: a, x1: b, x2: c, y1: d, y2: e};
	});
var _user$project$Types$TextFieldSettings = F2(
	function (a, b) {
		return {label: a, text: b};
	});
var _user$project$Types$LoadState = {ctor: 'LoadState'};
var _user$project$Types$SaveState = {ctor: 'SaveState'};
var _user$project$Types$Slider = F2(
	function (a, b) {
		return {ctor: 'Slider', _0: a, _1: b};
	});
var _user$project$Types$FlipGravity = function (a) {
	return {ctor: 'FlipGravity', _0: a};
};
var _user$project$Types$PlayerTwoName = function (a) {
	return {ctor: 'PlayerTwoName', _0: a};
};
var _user$project$Types$PlayerOneName = function (a) {
	return {ctor: 'PlayerOneName', _0: a};
};
var _user$project$Types$TogglePause = {ctor: 'TogglePause'};
...
var _user$project$Types$Repel = {ctor: 'Repel'};
var _user$project$Types$Attract = {ctor: 'Attract'};
var _user$project$Types$Reducer = {ctor: 'Reducer'};
var _user$project$Types$Normal = {ctor: 'Normal'};
var _user$project$Types$Right = {ctor: 'Right'};
var _user$project$Types$Left = {ctor: 'Left'};
var _user$project$Types$RightWin = {ctor: 'RightWin'};
var _user$project$Types$LeftWin = {ctor: 'LeftWin'};
var _user$project$Types$NoWin = {ctor: 'NoWin'};
var _user$project$Types$None = {ctor: 'None'};
var _user$project$Types$RightPlayer = {ctor: 'RightPlayer'};
var _user$project$Types$LeftPlayer = {ctor: 'LeftPlayer'};
var _user$project$Types$NotPressed = {ctor: 'NotPressed'};
var _user$project$Types$Pressed = {ctor: 'Pressed'};
var _user$project$Types$Down = {ctor: 'Down'};
var _user$project$Types$Up = {ctor: 'Up'};
var _user$project$Types$Win = {ctor: 'Win'};
var _user$project$Types$Pause = {ctor: 'Pause'};
var _user$project$Types$Play = {ctor: 'Play'};
var _user$project$Types$Two = {ctor: 'Two'};
var _user$project$Types$One = {ctor: 'One'};

var _user$project$Update$updateGravityStrength = F2(
	function (physicsSettings, number) {
		return _elm_lang$core$Native_Utils.update(
			physicsSettings,
			{
				gravitationalConstant: A3(_elm_lang$core$Basics$clamp, 0, 60, number)
			});
	});
var _user$project$Update$flipSign = F2(
	function (flip, number) {
		return flip ? _elm_lang$core$Basics$negate(number) : number;
	});
var _user$project$Update$flipAttactionType = function (attactionType) {
	return _elm_lang$core$Native_Utils.eq(attactionType, _user$project$Types$Attract) ? _user$project$Types$Repel : _user$project$Types$Attract;
};
var _user$project$Update$flipGravity = function (physicsSettings) {
	return _elm_lang$core$Native_Utils.update(
		physicsSettings,
		{
			gravityAttractionType: _user$project$Update$flipAttactionType(physicsSettings.gravityAttractionType)
		});
};
var _user$project$Update$flipWorldGravity = function (world) {
	return _elm_lang$core$Native_Utils.update(
		world,
		{
			physicsSettings: _user$project$Update$flipGravity(world.physicsSettings)
		});
};
var _user$project$Update$removeMergedSpheres = function (spheres) {
	return A2(
		_elm_lang$core$List$filter,
		function (e) {
			return _elm_lang$core$Native_Utils.eq(e.merged, false);
		},
		spheres);
};
var _user$project$Update$alreadyMerged = F2(
	function (spheresToMerge, sphere) {
		return A2(
			_elm_lang$core$List$any,
			function (f) {
				return _elm_lang$core$Native_Utils.cmp(f.mass.size, sphere.mass.size) > 0;
			},
			spheresToMerge) || A2(
			_elm_lang$core$List$any,
			function (f) {
				return _elm_lang$core$Native_Utils.eq(f.mass.size, sphere.mass.size) && (_elm_lang$core$Native_Utils.cmp(f.aliveFrames, sphere.aliveFrames) > 0);
			},
			spheresToMerge);
	});
var _user$project$Update$markAsMerged = function (sphere) {
	return _elm_lang$core$Native_Utils.update(
		sphere,
		{merged: true});
};
var _user$project$Update$groupFunction = F2(
	function (func, objects) {
		return objects;
	});
var _user$project$Update$filterNothings = function (list) {
	return A2(_elm_lang$core$List$filterMap, _elm_lang$core$Basics$identity, list);
};
var _user$project$Update$square = function (n) {
	return Math.pow(n, 2);
};
var _user$project$Update$sphereRadius = function (sphere) {
	return sphere.diameter / 2;
};
var _user$project$Update$calculateDiameter = F2(
	function (scale, mass) {
		return A2(
			F2(
				function (x, y) {
			...
			scale,
			_elm_lang$core$Basics$sqrt(mass / _elm_lang$core$Basics$pi));
	});
var _user$project$Update$updateDiameter = F2(
	function (scale, sphere) {
		return _elm_lang$core$Native_Utils.update(
			sphere,
			{
				diameter: A2(_user$project$Update$calculateDiameter, scale, sphere.mass.size)
			});
	});
var _user$project$Update$sumY = function (forces) {
...
var _user$project$Update$sumX = function (forces) {
	return _elm_lang$core$List$sum(
		A2(
			_elm_lang$core$List$map,
			function (f) {
...
var _user$project$Update$limitSphereVelocity = F2(
	function (settings, velocity) {
		return A3(
			_elm_lang$core$Basics$clamp,
			_elm_lang$core$Basics$negate(settings.maxSphereVelocity),
			settings.maxSphereVelocity,
			velocity);
	});
var _user$project$Update$updateVelocityForForces = F4(
	function (settings, velocity, mass, forces) {
		return _elm_lang$core$Native_Utils.update(
			velocity,
			{
				x: velocity.x + (_user$project$Update$sumX(forces) / mass),
				y: velocity.y + (_user$project$Update$sumY(forces) / mass)
			});
	});
var _user$project$Update$applyForcesToObject = F3(
	function (settings, sphere, forces) {
		return _elm_lang$core$Native_Utils.update(
			sphere,
			{
				velocity: A4(_user$project$Update$updateVelocityForForces, settings, sphere.velocity, sphere.mass.size, forces)
			});
	});
var _user$project$Update$euclideanDistance = F2(
	function (positionA, positionB) {
		return _elm_lang$core$Basics$sqrt(
			_user$project$Update$square(positionB.x - positionA.x) + _user$project$Update$square(positionB.y - positionA.y));
	});
var _user$project$Update$hasCollided = F2(
	function (sphereA, sphereB) {
		return A2(
			...
			A2(_user$project$Update$euclideanDistance, sphereA.position, sphereB.position),
			_user$project$Update$sphereRadius(sphereA) + _user$project$Update$sphereRadius(sphereB));
	});
var _user$project$Update$collidedSpheres = F2(
	function (sphere, otherSpheres) {
		return A2(
			_elm_lang$core$List$filter,
			function (e) {
				return _elm_lang$core$Native_Utils.cmp(
					A2(_user$project$Update$euclideanDistance, sphere.position, e.position),
					sphere.diameter + e.diameter) < 0;
			},
			otherSpheres);
	});
var _user$project$Update$calculateGravitationScalar = F4(
	function (gravConst, mass1, mass2, distance) {
		return {
			size: ((mass1.size * mass2.size) / Math.pow(distance, 2)) * (0 - gravConst)
		};
	});
var _user$project$Update$emptyForce = {x: 0, y: 0};
var _user$project$Update$apportianForce = F3(
	function (positionA, positionB, distance) {
		return (positionA - positionB) / distance;
	});
var _user$project$Update$calculateGravitation = F4(
	function (settings, dt, sphereA, sphereB) {
		var repel = _elm_lang$core$Native_Utils.eq(settings.gravityAttractionType, _user$project$Types$Repel);
		var distance = A2(_user$project$Update$euclideanDistance, sphereA.position, sphereB.position);
		var force = A4(_user$project$Update$calculateGravitationScalar, settings.gravitationalConstant, sphereA.mass, sphereB.mass, distance);
		return ((_elm_lang$core$Native_Utils.cmp(distance, sphereA.diameter) < 0) && (_elm_lang$core$Native_Utils.cmp(distance, sphereB.diameter) < 0)) ? _user$project$Update$emptyForce : {
			x: (dt * force.size) * A2(
				_user$project$Update$flipSign,
				repel,
				A3(_user$project$Update$apportianForce, sphereA.position.x, sphereB.position.x, distance)),
			y: (dt * force.size) * A2(
				_user$project$Update$flipSign,
				repel,
				A3(_user$project$Update$apportianForce, sphereA.position.y, sphereB.position.y, distance))
		};
	});
var _user$project$Update$applyGravitationForAll = F4(
	function (settings, dt, sphereA, spheres) {
		return A3(
			_user$project$Update$applyForcesToObject,
			settings,
			sphereA,
			A2(
				_elm_lang$core$List$map,
				function (s) {
					return A4(_user$project$Update$calculateGravitation, settings, dt, sphereA, s);
				},
				A2(
					_elm_lang$core$List$filter,
					function (s) {
...
var _user$project$Update$filterSpheres = F2(
...
var _user$project$Update$calculateNewPosistion = F2(
	function (velocity, position) {
		return {x: velocity.x + position.x, y: velocity.y + position.y};
	});
var _user$project$Update$calculateNewVelocityInAxis = F8(
	function (massA, massB, velocityA, velocityB, massA_, massB_, velocityA_, velocityB_) {
		var momentumBefore = (massA * velocityA) + (massB * velocityB);
		return momentumBefore / massA_;
	});
var _user$project$Update$calculateMomentum = F2(
	function (mass, velocity) {
		return mass * velocity;
	});
var _user$project$Update$updatePlayerPosistion = function (player) {
	return _elm_lang$core$Native_Utils.update(
		player,
		{
			position: A2(_user$project$Update$calculateNewPosistion, player.velocity, player.position)
		});
};
var _user$project$Update$updateSpherePosistion = function (sphere) {
	return _elm_lang$core$Native_Utils.update(
		sphere,
		{
			position: A2(_user$project$Update$calculateNewPosistion, sphere.velocity, sphere.position)
		});
};
var _user$project$Update$mergePosition = F2(
	function (positionA, positionB) {
		return _elm_lang$core$Native_Utils.update(
			positionA,
			{x: positionA.x + (positionB.x - positionA.x), y: positionA.y + (positionB.y - positionA.y)});
	});
var _user$project$Update$calculateNewVelocity = F4(
	function (sphereAPrior, sphereBPrior, sphereAPost, sphereBPost) {
		return {
			x: A8(_user$project$Update$calculateNewVelocityInAxis, sphereAPrior.mass.size, sphereBPrior.mass.size, sphereAPrior.velocity.x, sphereBPrior.velocity.x, sphereAPost.mass.size, sphereBPost.mass.size, sphereAPost.velocity.x, sphereBPost.velocity.x),
			y: A8(_user$project$Update$calculateNewVelocityInAxis, sphereAPrior.mass.size, sphereBPrior.mass.size, sphereAPrior.velocity.y, sphereBPrior.velocity.y, sphereAPost.mass.size, sphereBPost.mass.size, sphereAPost.velocity.y, sphereBPost.velocity.y)
		};
	});
var _user$project$Update$updateVelocity = F4(
	function (sphereAPrior, sphereBPrior, sphereAPost, sphereBPost) {
		return _elm_lang$core$Native_Utils.update(
			sphereAPost,
			{
				velocity: A4(_user$project$Update$calculateNewVelocity, sphereAPrior, sphereBPrior, sphereAPost, sphereBPost)
			});
	});
var _user$project$Update$sumMass = F2(
	function (massA, massB) {
		return _elm_lang$core$Native_Utils.update(
			massA,
			{size: massA.size + massB.size});
	});
var _user$project$Update$limitSphereMass = F2(
	function (world, mass) {
		return _elm_lang$core$Native_Utils.update(
			mass,
			{
				size: A3(_elm_lang$core$Basics$clamp, 0, world.physicsSettings.maxSphereSize, mass.size)
			});
	});
var _user$project$Update$largestMassSide = F4(
	function (sideA, sideB, massA, massB) {
		return (_elm_lang$core$Native_Utils.cmp(massA.size, massB.size) > 0) ? sideA : sideB;
	});
var _user$project$Update$mergeSphere = F3(
	function (world, sphereA, sphereB) {
		var sphereBPost = _elm_lang$core$Native_Utils.update(
			sphereB,
			{
				mass: {size: 0},
				position: {x: 0, y: 0},
		...
		var sphereAPost = _elm_lang$core$Native_Utils.update(
			sphereA,
			{
				mass: A2(
					_user$project$Update$limitSphereMass,
					world,
					A2(_user$project$Update$sumMass, sphereA.mass, sphereB.mass)),
				position: A2(_user$project$Update$mergePosition, sphereA.position, sphereB.position),
				side: A4(_user$project$Update$largestMassSide, sphereA.side, sphereB.side, sphereA.mass, sphereB.mass)
			});
		return A2(
			_user$project$Update$updateDiameter,
			sphereA.scale,
			A4(_user$project$Update$updateVelocity, sphereA, sphereB, sphereAPost, sphereBPost));
	});
var _user$project$Update$mergeSpheres = F3(
	function (world, sphere, otherSpheres) {
		var mergableSpheres = A2(_user$project$Update$collidedSpheres, sphere, otherSpheres);
		var _p0 = mergableSpheres;
		if (_p0.ctor === '[]') {
			return sphere;
		} else {
			var _p1 = _p0;
			return A2(_user$project$Update$alreadyMerged, _p1, sphere) ? _user$project$Update$markAsMerged(sphere) : A3(
				_elm_lang$core$List$foldl,
				_user$project$Update$mergeSphere(world),
				sphere,
				_p1);
		}
	});
var _user$project$Update$applySphereCollisions = F2(
	function (world, spheres) {
		return _user$project$Update$removeMergedSpheres(
			A2(
				_elm_lang$core$List$map,
				function (e) {
					return A3(
						_user$project$Update$mergeSpheres,
						world,
						e,
						A2(
							_elm_lang$core$List$filter,
							function (e1) {
								return !_elm_lang$core$Native_Utils.eq(e1, e);
							},
							spheres));
				},
				spheres));
	});
var _user$project$Update$playerOutOfBounds = F2(
	function (world, player) {
		return (_elm_lang$core$Native_Utils.cmp(player.position.y, world.innerContainer.y1) < 0) || (_elm_lang$core$Native_Utils.cmp(player.position.y + player.size, world.innerContainer.y2) > 0);
	});
var _user$project$Update$limitPlayerBoundary = F2(
	function (world, player) {
		return A2(_user$project$Update$playerOutOfBounds, world, player) ? _elm_lang$core$Native_Utils.update(
			player,
			{
				velocity: {x: 0, y: 0},
				position: {
					x: player.position.x,
					y: (_elm_lang$core$Native_Utils.cmp(player.position.y, world.innerContainer.y2 - player.size) > 0) ? (world.innerContainer.y2 - player.size) : world.innerContainer.y1
				}
			}) : player;
	});
var _user$project$Update$updatePlayerPositions = F2(
	function (world, players) {
		return A2(
			_elm_lang$core$List$map,
			function (e) {
				return _user$project$Update$updatePlayerPosistion(e);
			},
			A2(
				_elm_lang$core$List$map,
				function (e) {
					return A2(_user$project$Update$limitPlayerBoundary, world, e);
				},
				players));
	});
var _user$project$Update$makePositive = function (x) {
	return _elm_lang$core$Basics$abs(x);
};
var _user$project$Update$makeNegative = function (x) {
	return _elm_lang$core$Basics$negate(
		_user$project$Update$makePositive(x));
};
var _user$project$Update$applyHorizontalBoundaryCollisions = F2(
	function (sphere, world) {
		return (_elm_lang$core$Native_Utils.cmp(
			sphere.position.y - _user$project$Update$sphereRadius(sphere),
			world.leftSideLine.y1) < 0) ? _elm_lang$core$Native_Utils.update(
			sphere,
			{
				velocity: {
					x: sphere.velocity.x,
					y: _user$project$Update$makePositive(sphere.velocity.y)
				}
			}) : ((_elm_lang$core$Native_Utils.cmp(
			sphere.position.y + _user$project$Update$sphereRadius(sphere),
			world.leftSideLine.y2) > 0) ? _elm_lang$core$Native_Utils.update(
			sphere,
			{
				velocity: {
					x: sphere.velocity.x,
					y: _user$project$Update$makeNegative(sphere.velocity.y)
				}
			}) : sphere);
	});
var _user$project$Update$applyBoundaryCollisions = F2(
	function (world, spheres) {
		return A2(
			_elm_lang$core$List$map,
			function (e) {
				return A2(_user$project$Update$applyHorizontalBoundaryCollisions, e, world);
			},
			spheres);
	});
var _user$project$Update$collidedWithPaddle = F3(
	function (world, sphere, player) {
		var radius = _user$project$Update$sphereRadius(sphere);
		var _p2 = player;
		if (_p2.ctor === 'Nothing') {
			return false;
		} else {
			...
			var _p3 = _p4.side;
			if (_p3.ctor === 'Left') {
				return (_elm_lang$core$Native_Utils.cmp(sphere.position.x - radius, world.leftSideLine.x2) < 0) && ((_elm_lang$core$Native_Utils.cmp(sphere.position.y, _p4.position.y + _p4.size) < 0) && (_elm_lang$core$Native_Utils.cmp(sphere.position.y, _p4.position.y) > 0));
			} else {
				return (_elm_lang$core$Native_Utils.cmp(sphere.position.x + radius, world.rightSideLine.x1) > 0) && ((_elm_lang$core$Native_Utils.cmp(sphere.position.y, _p4.position.y + _p4.size) < 0) && (_elm_lang$core$Native_Utils.cmp(sphere.position.y, _p4.position.y) > 0));
			}
		}
	});
var _user$project$Update$winningPlayer = function (player) {
	return _elm_lang$core$Native_Utils.eq(player.score, 100);
};
var _user$project$Update$anyWinningPlayers = function (players) {
	return A2(
		_elm_lang$core$List$any,
		function (e) {
			return _user$project$Update$winningPlayer(e);
		},
		players);
};
var _user$project$Update$findPlayer = F2(
	function (side, players) {
		return _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (e) {
					return _elm_lang$core$Native_Utils.eq(e.side, side);
				},
				players));
	});
var _user$project$Update$sphereDefaultPosition = F3(
	function (sphere, side, world) {
		var _p5 = side;
		if (_p5.ctor === 'Left') {
			return {
				x: world.leftSideLine.x2 + _user$project$Update$sphereRadius(sphere),
				y: sphere.position.y
			};
		} else {
			return {
				x: world.rightSideLine.x1 - _user$project$Update$sphereRadius(sphere),
				y: sphere.position.y
			};
		}
	});
var _user$project$Update$sphereBeyondScoreLine = F3(
	function (side, sphere, world) {
		var _p6 = side;
		if (_p6.ctor === 'Left') {
			return _elm_lang$core$Native_Utils.cmp(
				sphere.position.x - _user$project$Update$sphereRadius(sphere),
				world.leftSideLine.x2) < 0;
		} else {
			return _elm_lang$core$Native_Utils.cmp(
				sphere.position.x + _user$project$Update$sphereRadius(sphere),
				world.rightSideLine.x1) > 0;
		}
	});
var _user$project$Update$markScoredSphere = F2(
	function (sphere, world) {
		return A3(_user$project$Update$sphereBeyondScoreLine, _user$project$Types$Left, sphere, world) ? _elm_lang$core$Native_Utils.update(
			sphere,
			{hitType: _user$project$Types$LeftPlayer}) : (A3(_user$project$Update$sphereBeyondScoreLine, _user$project$Types$Right, sphere, world) ? _elm_lang$core$Native_Utils.update(
			sphere,
			{hitType: _user$project$Types$RightPlayer}) : sphere);
	});
var _user$project$Update$markScoredSpheres = F2(
	function (spheres, world) {
		return A2(
			_elm_lang$core$List$map,
			function (e) {
				return A2(_user$project$Update$markScoredSphere, e, world);
			},
			spheres);
	});
var _user$project$Update$removeScoredSpheres = function (world) {
	return _elm_lang$core$Native_Utils.update(
		world,
		{
			spheres: A2(
				_elm_lang$core$List$filter,
				function (e) {
					return _elm_lang$core$Native_Utils.eq(e.hitType, _user$project$Types$None);
				},
				world.spheres)
		});
};
var _user$project$Update$applyPaddleCollision = F2(
	function (sphere, world) {
		return A3(
			_user$project$Update$collidedWithPaddle,
			world,
			sphere,
			A2(_user$project$Update$findPlayer, _user$project$Types$Left, world.players)) ? _elm_lang$core$Native_Utils.update(
			sphere,
			{
				velocity: {
					x: _user$project$Update$makePositive(sphere.velocity.x),
					y: sphere.velocity.y
				},
				position: A3(_user$project$Update$sphereDefaultPosition, sphere, _user$project$Types$Left, world)
			}) : (A3(
			_user$project$Update$collidedWithPaddle,
			world,
			sphere,
			A2(_user$project$Update$findPlayer, _user$project$Types$Right, world.players)) ? _elm_lang$core$Native_Utils.update(
			sphere,
			{
				velocity: {
					x: _user$project$Update$makeNegative(sphere.velocity.x),
					y: sphere.velocity.y
				},
				position: A3(_user$project$Update$sphereDefaultPosition, sphere, _user$project$Types$Right, world)
			}) : sphere);
	});
var _user$project$Update$applyPaddleCollisions = F2(
	function (world, spheres) {
		return A2(
			_elm_lang$core$List$map,
			function (e) {
				return A2(_user$project$Update$applyPaddleCollision, e, world);
			},
			spheres);
	});
var _user$project$Update$updateSpherePositions = function (spheres) {
	return A2(
		_elm_lang$core$List$map,
		function (e) {
			return _user$project$Update$updateSpherePosistion(e);
		},
		spheres);
};
var _user$project$Update$applyPlayerMovementForce = F2(
	function (dt, player) {
		var maxVelocity = 15;
		var dragPercentage = 0.3;
		var acceleration = 0.6;
		var upVelocity = function () {
			var _p7 = player.upAction;
			if (_p7.ctor === 'Pressed') {
				return player.velocity.y - acceleration;
			} else {
				return player.velocity.y * dragPercentage;
			}
		}();
		var downVelocity = function () {
			var _p8 = player.downAction;
			if (_p8.ctor === 'Pressed') {
				return player.velocity.y + acceleration;
			} else {
				return player.velocity.y * dragPercentage;
		...
		return _elm_lang$core$Native_Utils.update(
			player,
			{
				velocity: {
					...
					y: A3(
						_elm_lang$core$Basics$clamp,
						_elm_lang$core$Basics$negate(maxVelocity),
						maxVelocity,
						upVelocity + downVelocity)
				}
			});
	});
var _user$project$Update$applyPlayerForces = F2(
	function (dt, players) {
		return A2(
			_elm_lang$core$List$map,
			function (e) {
				return A2(_user$project$Update$applyPlayerMovementForce, dt, e);
			},
			players);
	});
var _user$project$Update$applyForces = F3(
	function (settings, dt, spheres) {
		return A2(
			_elm_lang$core$List$map,
			function (e) {
				return A4(_user$project$Update$applyGravitationForAll, settings, dt, e, spheres);
			},
			spheres);
	});
var _user$project$Update$incrementWeaponLastFired = F2(
	function (dt, players) {
		return A2(
			_elm_lang$core$List$map,
			function (e) {
				return _elm_lang$core$Native_Utils.update(
					e,
					{weaponLastFired: e.weaponLastFired + dt});
			},
			players);
	});
var _user$project$Update$incrementLifetime = function (spheres) {
	return A2(
		_elm_lang$core$List$map,
		function (e) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Update$scored = F2(
	function (side, sphere) {
		var _p9 = side;
		if (_p9.ctor === 'Left') {
			return _elm_lang$core$Native_Utils.eq(sphere.hitType, _user$project$Types$LeftPlayer);
		} else {
			return _elm_lang$core$Native_Utils.eq(sphere.hitType, _user$project$Types$RightPlayer);
		}
	});
var _user$project$Update$toPercentage = F2(
	function (numerator, denominator) {
		return (numerator / denominator) * 100;
	});
var _user$project$Update$playerScoreAsPercentage = F3(
	function (settings, player, spheres) {
		return function (e) {
			return A2(_user$project$Update$toPercentage, e, settings.scoreForGame);
		}(
			_elm_lang$core$List$sum(
				A2(
					...
					A2(
						_elm_lang$core$List$filter,
						function (e) {
							return A2(_user$project$Update$scored, player.side, e);
						},
						spheres))));
	});
var _user$project$Update$updateForWin = function (world) {
	return _user$project$Update$anyWinningPlayers(world.players) ? _elm_lang$core$Native_Utils.update(
		world,
		{state: _user$project$Types$Win}) : world;
};
var _user$project$Update$updateWinningPlayer = function (player) {
	return _elm_lang$core$Native_Utils.eq(player.score, 100) ? _elm_lang$core$Native_Utils.update(
		player,
		{gamesWon: player.gamesWon + 1}) : player;
};
var _user$project$Update$updatePlayerScore = F3(
	function (settings, player, spheres) {
		return _elm_lang$core$Native_Utils.update(
			player,
			{
				score: A3(
					...
					0,
					100,
					player.score + A3(_user$project$Update$playerScoreAsPercentage, settings, player, spheres))
			});
	});
var _user$project$Update$updateWinningPlayers = function (world) {
	return _elm_lang$core$Native_Utils.update(
		world,
		{
			players: A2(
				_elm_lang$core$List$map,
				function (e) {
					return _user$project$Update$updateWinningPlayer(e);
				},
				world.players)
		});
};
var _user$project$Update$updatePlayerScores = function (world) {
	return _elm_lang$core$Native_Utils.update(
		world,
		{
			players: A2(
				_elm_lang$core$List$map,
				function (e) {
					return A3(_user$project$Update$updatePlayerScore, world.gameSettings, e, world.spheres);
				},
				world.players)
		});
};
var _user$project$Update$limitSpheres = function (world) {
	return _elm_lang$core$Native_Utils.update(
		world,
		{
			spheres: A2(
				_elm_lang$core$List$take,
				_elm_lang$core$Basics$round(world.gameSettings.sphereLimit),
				A2(
					_elm_lang$core$List$sortBy,
					function (_) {
						return _.aliveFrames;
					},
					world.spheres))
		});
};
var _user$project$Update$applyPhysics = F2(
	function (dt, world) {
		return _elm_lang$core$Native_Utils.update(
			world,
			{
				spheres: _user$project$Update$incrementLifetime(
					A2(
						_user$project$Update$applyPaddleCollisions,
						world,
						A2(
							_user$project$Update$applySphereCollisions,
							world,
							_user$project$Update$updateSpherePositions(
								A2(
									_user$project$Update$applyBoundaryCollisions,
									world,
									A3(_user$project$Update$applyForces, world.physicsSettings, dt, world.spheres)))))),
				players: A2(
					_user$project$Update$incrementWeaponLastFired,
					dt,
					A2(
						_user$project$Update$updatePlayerPositions,
						world,
						A2(_user$project$Update$applyPlayerForces, dt, world.players)))
			});
	});
var _user$project$Update$applyScoring = function (world) {
	return _user$project$Update$updateForWin(
		_user$project$Update$updateWinningPlayers(
			_user$project$Update$removeScoredSpheres(
				_user$project$Update$updatePlayerScores(
					_elm_lang$core$Native_Utils.update(
						world,
						{
							spheres: A2(_user$project$Update$markScoredSpheres, world.spheres, world)
						})))));
};
var _user$project$Update$caclulateShotPosition = F2(
	function (player, radius) {
		return {
			x: function () {
				var _p10 = player.side;
				if (_p10.ctor === 'Left') {
					return player.position.x + radius;
				} else {
					return player.position.x - radius;
				}
			}(),
...
var _user$project$Update$createSphere = F3(
	function (player, initialMass, velocity) {
		var scale = 5;
		return {
			id: 'A',
			side: player.side,
			position: A2(
				_user$project$Update$caclulateShotPosition,
				player,
				A2(_user$project$Update$calculateDiameter, scale, initialMass.size) / 2),
			mass: initialMass,
			diameter: A2(_user$project$Update$calculateDiameter, scale, initialMass.size),
			velocity: velocity,
			aliveFrames: 0,
			scale: scale,
			merged: false,
			hitType: _user$project$Types$None
		};
	});
var _user$project$Update$caclulateShotMass = F2(
	function (settings, player) {
		return {
			size: A3(_elm_lang$core$Basics$clamp, 0, settings.maxShotSize, player.weaponLastFired * settings.shotTimeFactor)
		};
	});
var _user$project$Update$caclulateShotVelocity = function (player) {
	var velocityMultiplierX = 0.7;
	var velocityMultiplierY = 0.7;
	return {
		x: function () {
			var _p11 = player.side;
			if (_p11.ctor === 'Left') {
				return player.mass.size * velocityMultiplierX;
			} else {
				return _elm_lang$core$Basics$negate(player.mass.size * velocityMultiplierX);
			}
		}(),
		y: player.velocity.y * velocityMultiplierY
	};
};
var _user$project$Update$shootBall = F2(
	function (player, world) {
		return (_elm_lang$core$Native_Utils.cmp(
			A2(_user$project$Update$caclulateShotMass, world.gameSettings, player).size,
			world.gameSettings.minShotSize) < 0) ? world : _elm_lang$core$Native_Utils.update(
			world,
			{
				spheres: A2(
					_elm_lang$core$List$append,
					world.spheres,
					{
						ctor: '::',
						_0: A3(
							_user$project$Update$createSphere,
							player,
							A2(_user$project$Update$caclulateShotMass, world.gameSettings, player),
							_user$project$Update$caclulateShotVelocity(player)),
						_1: {ctor: '[]'}
					}),
				players: A2(
					_elm_lang$core$List$map,
					function (e) {
						return _elm_lang$core$Native_Utils.eq(e.side, player.side) ? _elm_lang$core$Native_Utils.update(
							player,
							{weaponLastFired: 0}) : e;
					},
					world.players)
...
var _user$project$Update$attemptShot = F2(
	function (world, side) {
		var _p12 = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (p) {
					return _elm_lang$core$Native_Utils.eq(p.side, side);
				},
				world.players));
		if (_p12.ctor === 'Nothing') {
			return world;
		} else {
			return A2(_user$project$Update$shootBall, _p12._0, world);
		}
	});
var _user$project$Update$updatePlayerName = F3(
	function (newName, side, world) {
		return _elm_lang$core$Native_Utils.update(
			world,
			{
				players: A2(
					_elm_lang$core$List$map,
					function (e) {
						return _elm_lang$core$Native_Utils.eq(e.side, side) ? _elm_lang$core$Native_Utils.update(
							e,
							{name: newName}) : e;
					},
					world.players)
...
var _user$project$Update$updatePlayerAction = F3(
	function (player, keyboardAction, direction) {
		var _p13 = direction;
		if (_p13.ctor === 'Up') {
			return _elm_lang$core$Native_Utils.update(
				player,
				{upAction: keyboardAction});
		} else {
			return _elm_lang$core$Native_Utils.update(
				player,
				{downAction: keyboardAction});
		}
	});
var _user$project$Update$updatePlayerActions = F4(
	function (world, side, keyboardAction, direction) {
		return _elm_lang$core$Native_Utils.update(
			world,
			{
				players: A2(
					_elm_lang$core$List$map,
					function (p) {
						return _elm_lang$core$Native_Utils.eq(p.side, side) ? A3(_user$project$Update$updatePlayerAction, p, keyboardAction, direction) : p;
					},
					world.players)
			});
	});
var _user$project$Update$applyPlayerKeyChange = F3(
	function (keyCode, action, world) {
		var _p14 = keyCode;
		switch (_p14) {
			case 38:
				return A4(_user$project$Update$updatePlayerActions, world, _user$project$Types$Right, action, _user$project$Types$Up);
			case 40:
				return A4(_user$project$Update$updatePlayerActions, world, _user$project$Types$Right, action, _user$project$Types$Down);
			case 87:
				return A4(_user$project$Update$updatePlayerActions, world, _user$project$Types$Left, action, _user$project$Types$Up);
			case 83:
				return A4(_user$project$Update$updatePlayerActions, world, _user$project$Types$Left, action, _user$project$Types$Down);
			case 68:
				var _p15 = action;
				if (_p15.ctor === 'Pressed') {
					return A2(_user$project$Update$attemptShot, world, _user$project$Types$Left);
				} else {
					return world;
				}
			case 37:
				var _p16 = action;
				if (_p16.ctor === 'Pressed') {
					return A2(_user$project$Update$attemptShot, world, _user$project$Types$Right);
				} else {
					return world;
				}
			default:
...
var _user$project$Update$update = F2(
	function (msg, world) {
		...
		switch (_p17.ctor) {
			case 'Tick':
				var _p18 = world.state;
				switch (_p18.ctor) {
					case 'Play':
						return {
							ctor: '_Tuple2',
							_0: _user$project$Update$applyScoring(
								A2(_user$project$Update$applyPhysics, _p17._0, world)),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'Pause':
			...
			case 'KeyDown':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Update$applyPlayerKeyChange, _p17._0, _user$project$Types$Pressed, world),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyUp':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Update$applyPlayerKeyChange, _p17._0, _user$project$Types$NotPressed, world),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'TogglePause':
				var _p19 = world.state;
				switch (_p19.ctor) {
					case 'Play':
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								world,
								{state: _user$project$Types$Pause}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					case 'Pause':
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								world,
								{state: _user$project$Types$Play}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					default:
						return {
			...
			case 'PlayerOneName':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Update$updatePlayerName, _p17._0, _user$project$Types$Left, world),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'PlayerTwoName':
				return {
					ctor: '_Tuple2',
					_0: A3(_user$project$Update$updatePlayerName, _p17._0, _user$project$Types$Right, world),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FlipGravity':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Update$flipWorldGravity(world),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Slider':
				var _p20 = _p17._0;
				if (_p20 === 1) {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							world,
							{
								physicsSettings: A2(_user$project$Update$updateGravityStrength, world.physicsSettings, _p17._1)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
			...
			case 'LoadState':
				return {ctor: '_Tuple2', _0: world, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				return A3(_debois$elm_mdl$Material$update, _user$project$Types$Mdl, _p17._0, world);
		}
	});
