...
var _user$project$View$outerSphereColour = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$svg$Svg_Attributes$offset('100%'),
			_elm_lang$svg$Svg_Attributes$stopColor('#0B79CE'),
			_elm_lang$svg$Svg_Attributes$stopOpacity('1')
		]),
	_elm_lang$core$Native_List.fromArray(
		[]));
var _user$project$View$innerSphereColour = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$svg$Svg_Attributes$stopColor('#0B79CE'),
			_elm_lang$svg$Svg_Attributes$stopOpacity('0.3')
		]),
	_elm_lang$core$Native_List.fromArray(
		[]));
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Basics$toString(sphere.position.x)),
				_elm_lang$svg$Svg_Attributes$cy(
				_elm_lang$core$Basics$toString(sphere.position.y)),
				_elm_lang$svg$Svg_Attributes$r(
				_elm_lang$core$Basics$toString(sphere.diameter)),
